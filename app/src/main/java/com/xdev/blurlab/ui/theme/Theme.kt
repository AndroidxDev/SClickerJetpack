package com.xdev.blurlab.ui.theme
...
val LocalBlurLabThemeTheme = staticCompositionLocalOf<BlurLabThemeState> {
...
fun BlurLabTheme(
    ...
    CompositionLocalProvider(
        LocalBlurLabThemeTheme provides BlurLabThemeState(
            isDark = darkTheme,
